...
public class RubyMultiTool extends ItemTool {
    ...
    public RubyMultiTool(){
        super(5F, ModRegMaterial.RUBY_TOOL_MATERIAL, HARVEST_BLOCKS);
        setUnlocalizedName("ruby_multi_tool");
        setTextureName(ExampleMod.MODID + ":ruby_multi_tool");
        setCreativeTab(ModItemGroop.ModTools);

        final int harvestLvl = ModRegMaterial.RUBY_TOOL_MATERIAL.getHarvestLevel();
